...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_ansi_regular_shift_regular_backspace(
        ...
        KC_LCTRL, KC_LGUI, KC_LALT,                      KC_SPC,                  KC_RALT, MO(_FN), KC_RCTRL
    ),
    [_FN] = LAYOUT_ansi_regular_shift_regular_backspace(
        KC_GRV, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8,   KC_F9, KC_F10,    KC_F11, KC_F12, KC_DEL,
        _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______,     _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_VOLD, KC_VOLU, _______,
    ...
    [_FN2] = LAYOUT_ansi_regular_shift_regular_backspace(
        _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______,    DEBUG, EEPROM_RESET, RESET,
        _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
