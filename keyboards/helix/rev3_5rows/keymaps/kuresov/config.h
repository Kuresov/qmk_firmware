...
// Ensure that the shorted intersection defined in the defaults indicates
// which is the left side (i.e. low is left)
...
#define MASTER_RIGHT
  ...
  #define RGB_MATRIX_TYPING_HEATMAP_DECREASE_DELAY_MS 6
  #define DISBLE_RGB_MATRIX_DIGITAL_RAIN        // That famous computer simulation
#endif
  ...
  // Default animation when EEPROM is cleared
  #define RGBLIGHT_DEFAULT_MODE RGBLIGHT_MODE_STATIC_LIGHT
  // If defined, the RGB lighting will be switched off when the host goes to sleep
  #define RGBLIGHT_SLEEP

  // Define enabled effects below
#endif
