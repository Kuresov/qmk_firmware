...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |  =   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl |      |      |      |  GUI | Space| Ctrl | Entr | Shft | Ctrl |      |      | L_1  | L_2  |
   * `-------------------------------------------------------------------------------------------------'
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL,  _______, _______, _______, KC_LGUI, KC_SPC, KC_LCTL, KC_ENT,  KC_LSFT, KC_RCTL,  _______,   _______, L_1,        L_2 \
    ),
   ...
   * |-------+-------+-------+-------+-------+-------|               |-------+-------+-------+-------+-------+-------|
   * |       |RGB_TOG|RGB_MOD|RGBRMOD|       |       |               |       | Bri Dn| Bri Up|  F11  |  F12  |   \   |
   * |-------+-------+-------+-------+-------+-------|               |-------+-------+-------+-------+-------+-------|
  ...
  [_L_1] = LAYOUT( \
      ...
      _______, RGB_TOG, RGB_MOD, RGB_RMOD, _______, _______,                   _______, KC_BRID, KC_BRIU, KC_F11,  KC_F12,  KC_BSLS,
  ...
  [_L_2] = LAYOUT( \
      QK_BOOT, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, QK_BOOT,
       QK_RBT, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______,  QK_RBT,
