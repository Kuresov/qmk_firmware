...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |  =   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl |      |      |  GUI |  Alt | Space| Shft | L_2  | Enter| Ctrl |      |      | L_1  | L_2  |
   * `-------------------------------------------------------------------------------------------------'
  ...
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL,  _______, _______, KC_LGUI, KC_LALT, KC_SPC, KC_LSFT, KC_RCTL, KC_ENT,  KC_LSFT,  _______,   _______, _______,     L_1  \
    ),
